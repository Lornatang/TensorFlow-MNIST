...
def load_data(name='mnist', train_size=7, val_size=2, test_size=1, buffer_size=1000, batch_size=16):
...
def get_label_name(name='mnist', train_size=7, val_size=2, test_size=1):
  """ load every cats_vs_dogs dataset.
